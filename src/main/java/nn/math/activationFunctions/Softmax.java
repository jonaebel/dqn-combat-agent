...
public class Softmax implements ActivationFunction {
    ...
    /*
     Row-wise softmax: softmax(x_i) = exp(x_i) / sum(exp(x_j))
     Subtracts the row-max for numerical stability.
    */
    @Override
    ...
    /*
     Element-wise diagonal derivative: s_i * (1 - s_i).
     Use SoftmaxCCE instead when combined with categorical cross-entropy.
    */
    @Override
